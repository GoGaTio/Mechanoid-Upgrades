...
namespace MU
{
	...
	public class StatPart_UpgradesFromWeightClass : StatPart
	{
		...
		{
			float num = 1f;
			switch (pawn.RaceProps.mechWeightClass)
			{
	...
	public class HediffComp_ShieldBoost : HediffComp
	{
		...
		private int EnergyGain => Mathf.RoundToInt(Props.baseEnergyGain * Props.energyGainFromWeightClass.Evaluate((int)parent.pawn.RaceProps.mechWeightClass));

...
namespace MU
{
	...
	public class CompProperties_AbilityBurner_AICastable : CompProperties_AbilityBurner
    {
		public CompProperties_AbilityBurner_AICastable()
		{
			compClass = typeof(CompAbilityEffect_Burner_AICastable);
		}
	}

	public class CompAbilityEffect_Burner_AICastable : CompAbilityEffect_Burner
    {
		public override bool AICanTargetNow(LocalTargetInfo target)
		{
			return true;

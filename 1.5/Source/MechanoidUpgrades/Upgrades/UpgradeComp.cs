...
namespace MU
{
	...
	public abstract class UpgradeComp
	{
		...
		public virtual void GetOffsetsExplanation(StatDef stat, StringBuilder sb)//new
		{
		}

		public virtual void GetFactorsExplanation(StatDef stat, StringBuilder sb)//new
		{
		}
	...
	public class UpgradeComp_Shield : UpgradeComp
	{
		...
		{
			absorbed = false;
			if (dinfo.IgnoreInstantKillProtection || ShieldState != 0 || Mech == null)
			{
				return;
			}
